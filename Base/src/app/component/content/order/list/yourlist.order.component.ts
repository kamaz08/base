...
@Component({
    selector: 'yourlistorder',
    templateUrl: './yourlist.order.component.html',
    styles: [``]
})
export class YourListOrderComponent {
    ...
    public GetOrder() {
        this.Load = true;
        this._service.GetUserOrders(this.GetLastId()).subscribe(x => this.SetOrders(x), x => { });
    }
